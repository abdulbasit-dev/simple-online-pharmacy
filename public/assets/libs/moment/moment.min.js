!(function (e, t) {
  ...
  function dt(e) {
    ...
    return (
      n &&
        -2 === g(e).overflow &&
        ((t = n[_e] < 0 || 11 < n[_e] ? _e : n[ye] < 1 || n[ye] > Pe(n[me], n[_e]) ? ye : n[ge] < 0 || 24 < n[ge] || (24 === n[ge] && (0 !== n[ve] || 0 !== n[pe] || 0 !== n[we])) ? ge : n[ve] < 0 || 59 < n[ve] ? ve : n[pe] < 0 || 59 < n[pe] ? pe : n[we] < 0 || 999 < n[we] ? we : -1),
  ...
  function $t(s, i) {
    return function (e, t) {
      var n;
      return (
        null === t || isNaN(+t) || (T(i, 'moment().' + i + '(period, number) is deprecated. Please use moment().' + i + '(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info.'), (n = e), (e = t), (t = n)),
  ...
  return (
    ...
    (qn.abs = function () {
      var e = this._data;
      return (
        (this._milliseconds = wn(this._milliseconds)), (this._days = wn(this._days)), (this._months = wn(this._months)), (e.milliseconds = wn(e.milliseconds)), (e.seconds = wn(e.seconds)), (e.minutes = wn(e.minutes)), (e.hours = wn(e.hours)), (e.months = wn(e.months)), (e.years = wn(e.years)), this
      );
    }),
    (qn.add = function (e, t) {
    ...
    (qn.humanize = function (e) {
      ...
      var t,
        ...
        f =
          ...
          (l = An(i.as('M'))),
          (h = An(i.as('y'))),
          ((d = (r <= jn.ss && ['s', r]) || (r < jn.s && ['ss', r]) || (a <= 1 && ['m']) || (a < jn.m && ['mm', a]) || (o <= 1 && ['h']) || (o < jn.h && ['hh', o]) || (u <= 1 && ['d']) || (u < jn.d && ['dd', u]) || (l <= 1 && ['M']) || (l < jn.M && ['MM', l]) || (h <= 1 && ['y']) || ['yy', h])[2] =
            n),
          (d[3] = 0 < +t),
          (d[4] = s),
          function (e, t, n, s, i) {
