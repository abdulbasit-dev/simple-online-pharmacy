        ...
        <div class="card-body pt-0">
          <div class="d-flex justify-content-between align-items-start">
            ...
            <div class="">
              <div class="pt-4">
                <div class="mt-4">
                  <a href="" class="btn btn-outline-primary waves-effect waves-light btn-sm" data-bs-toggle="modal"
                    data-bs-target=".update-profile">@lang('buttons.edit_resource', ['resource' => __('attributes.profile')])</a>
            ...
            <table class="table-nowrap mb-0 table">
              <tbody>
                ...
                <tr>
                  ...
                  <td id="phone_alt">{{ Auth::user()->phone_alt ?? '---' }}</td>
                </tr>
                <tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="needs-validation" novalidate enctype="multipart/form-data" id="update-profile">
            ...
            <div class="mb-3">
              <label for="phone_alt" class="col-form-label">@lang('translation.user.phone_alt')</label>
              <input type="tel" class="form-control" id="phone_alt" name="phone_alt"
                value="{{ old('phone_alt', auth()->user()->phone_alt) }}">
              <div class="valid-feedback">
                @lang('validation.good')
              </div>
              <div class="invalid-feedback">
            ...
            <div class="d-grid mt-3">
              <button class="btn btn-primary waves-effect waves-light UpdateProfile" data-id="{{ Auth::user()->id }}"
                type="submit">@lang('buttons.update')</button>
            </div>
          </form>
        </div>
      </div><!-- /.modal-content -->
