    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form class="needs-validation" novalidate action="{{ route('admin.origins.update', $origin->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-8">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $origin->name) }}" required>
