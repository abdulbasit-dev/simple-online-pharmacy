...
@section('title')
  @lang('translation.resource_info', ['resource' => __('attributes.user')])
@endsection
        ...
        <div class="card-body border-bottom">
          <div class="float-end dropdown ms-2">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <a class="dropdown-item" href="{{ route('admin.users.edit', $user->id) }}">@lang('translation.edit_resource', ['resource' => __('attributes.user')])</a>
              ...
              <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" id="userShowDeleteForm_{{ $user->id }}">
                @csrf
                @method('DELETE')
              </form>
            </div>
          ...
          <div class="mb-4">
            <img src="{{ getAvatar($user) }}" class="rounded-circle avatar-lg" alt="Responsive image">
          </div>
