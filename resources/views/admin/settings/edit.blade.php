...
@section('title')
  @lang('translation.setting.edit_setting')
@endsection
    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form class="needs-validation" novalidate action="{{ route('admin.settings.update', $setting->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-8">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    ...
                    <div class="invalid-feedback">
                      @lang('validation.required', ['attribute' => __('translation.setting.name')])
                    </div>
                  </div>
                </div>
